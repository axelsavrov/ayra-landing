...
// (Opcional) si ya tienes este componente, déjalo; si no, quítalo del JSX de abajo
// import ContextsShowcase from "./components/ContextsShowcase";

/* =========================================================
   Ayra — Landing (tipo Apple) con:
   - Hero con video dentro de iPhone
   - Mini chat demo modal
   - Dark/Light toggle
   - Secciones: Modules, Roadmap, Testimonials, Founder
   - Trusted partners pequeño al final
   - Waitlist con Formspree
   ========================================================= */
...
export default function AyraLanding() {
  ...
  return (
    ...
    >
      ...
      {/* Si tienes tu carrusel de Contextos, descomenta */}
      {/* <ContextsShowcase /> */}
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 py-20 grid lg:grid-cols-[1.05fr_0.95fr] gap-16 items-center">
        ...
        >
          {/* Marco del iPhone (simple rectangle + shadow para efecto) */}
          <div
            className={[
...
function HeroVideoFallback({ isDark }: { isDark: boolean }) {
  // Si el video falla, mostramos la imagen
      ...
      <div className="mt-16 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
        {mods.map((m) => (
          ...
          >
            ...
            <p className={isDark ? "text-sm text-neutral-400" : "text-sm text-neutral-600"}>
              {m.desc}
            </p>
          </motion.div>
        ))}
      ...
      <div className="mt-16 grid md:grid-cols-3 gap-10">
        {steps.map((s, i) => (
          ...
          >
            ...
            <p className={["mt-3 text-sm", isDark ? "text-neutral-300" : "text-neutral-700"].join(" ")}>
              {s.desc}
            </p>
          </motion.div>
        ))}
      ...
      <div className="mt-12 grid gap-10 md:grid-cols-3">
        {quotes.map((q, i) => (
          ...
          >
            ...
            <div className={["mt-6 text-sm font-medium", isDark ? "text-neutral-400" : "text-neutral-600"].join(" ")}>
              {q.author}
            </div>
          </motion.div>
        ))}
    ...
    <section id="founder" className="mx-auto max-w-5xl px-6 py-28 text-center space-y-12">
      ...
      >
        <div className="flex flex-col items-center gap-8">
          ...
          <p className={["mt-10 italic text-sm max-w-xl", isDark ? "text-neutral-500" : "text-neutral-500"].join(" ")}>
    ...
    <section id="waitlist" className="mx-auto max-w-3xl px-6 py-28 text-center">
      ...
      >
        ...
        {!submitted ? (
          ...
          <p className="mt-6 text-lg text-green-500 font-medium">
...
function Footer({ isDark }: { isDark: boolean }) {
  return (
    <footer
      className={[
        "border-t",
        isDark ? "border-white/10 bg-black/90" : "border-black/10 bg-white/90",
      ].join(" ")}
    >
